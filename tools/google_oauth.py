...
def login_button(authorization_url, app_name, app_desc):
    ...
    st.markdown(
        ...
        <button style='border: none; border-radius: 5px; background-color: white; color: black; font-size:18px; font-weight: bold; font-family:monospace;' type="button">Logga in med Google</button>
        </a>
        """,
        unsafe_allow_html=True,
    )
